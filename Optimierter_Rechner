...
{
    public class Optimierter_Rechner
    {
        static RechnerManager rechnerManager = new RechnerManager();

        public static Program program = new Program();
        public static Hilfsfunktionen help = new Hilfsfunktionen();
        ...
        static MatrixRechner matrixRechner = new MatrixRechner();
        ...
        public void Start()
        {
            ...
            while (programmLaeuft)
            {
                ...
                {
                    matrixRechner.ZeigeMatrixMenue();
                }
                else { 
                ...
                try
                {
                    switch (wahl)
                    {
                        case 1: // Berechnung durchführen
                            if (aktueller.ToLower() == "matrix-rechner")
                            {
                                matrixRechner.ZeigeBerechnungen();
                            }
                            else
                            {
                        ...
                        case 5: // Datenbank-Historie
                            datenbankmenu.DatenbankHistorieAnzeigen();
                            break;
                        case 6: // Statistiken
                            statistikmenu.StatistikMenu();
                            break;
                        case 7: // Einstellungen
                            konfigmenu.KonfigurationAendern();
                            break;
            ...
            {
                Konfigmenu.KonfigurationSpeichern();
        ...
        static void BenutzerManagement()
        {
